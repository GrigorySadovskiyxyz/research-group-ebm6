---
# Display name
title: Летун Сергей Александрович
...
- icon: envelope
  icon_pack: fas
  link: 'mailto:test@s.letun@bmstu.ru'
- icon: researchgate
  icon_pack: ai
...
Старший преподаватель, генеральный директор компании "Полисет Инвест", куратор направления "Международный трансфер технологий".